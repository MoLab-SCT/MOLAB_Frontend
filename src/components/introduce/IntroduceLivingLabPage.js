    ...
    <div className="introduce_wrapper">
      ...
      <div className="definition" id="definition">
        ...
        <section className="livinglab_definiton">
          <h2>“살아있는 실험실”</h2>
            <p>리빙랩은 사용자의 관점에서 삶에 실질적인 도움이 되는 연구를 말합니다.<br/>
      ...
      <div className="livinglab_example" id="example">
        ...
        <section className="example_paragraph">
          ...
          <p>암스테르담의 스마트시티 조성은 ASC라는 조직이 주도하고 있습니다. ASC에는 정부뿐만 아니라 민간 기업, 학교, 지역주민들이 몸담고 있습니다. 마이크 오식 홍보담당 책임은 “ASC는 다양한 이해관계자가 도시 문제를 해결하기 위해 각종 아이디어를 내고 실행하는 오픈 플랫폼”이라고 소개했습니다.</p>
        </section>
      </div>
      <div class="livinglab_pros" id="pros">
        ...
        어쩌면 우리 동네에서는 이미 시작되고 있을지 모릅니다!<br/><span className="highlight">지금 한 번 참여해 볼까요?</span></p>
    </div>
        </div>
    </div>
  </main>
